...
def add_position_route(
    ...
    return add_position_service(guild_id, dto, db, payload)
...
def get_position_list_route(
    ...
    return get_position_list_service(guild_id, db, payload)
...
def get_position_detail_route(
    ...
    return get_position_detail_service(guild_id, position_id, db, payload)
...
def update_position_route(
    ...
    return update_position_service(guild_id, position_id, dto, db, payload)
...
def delete_position_route(
    ...
    return delete_position_service(guild_id, position_id, db, payload)
