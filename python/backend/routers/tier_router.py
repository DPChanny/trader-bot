...
def add_tier_route(
    ...
    return add_tier_service(guild_id, preset_id, dto, db, payload)
...
def get_tier_list_route(
    ...
    return get_tier_list_service(guild_id, preset_id, db, payload)
...
def get_tier_detail_route(
    ...
    return get_tier_detail_service(guild_id, preset_id, tier_id, db, payload)
...
def update_tier_route(
    ...
    return update_tier_service(guild_id, preset_id, tier_id, dto, db, payload)
...
def delete_tier_route(
    ...
    return delete_tier_service(guild_id, preset_id, tier_id, db, payload)
